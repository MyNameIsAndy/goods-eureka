...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <body id="one">
    ...
    <div class="container-fluid xd-container">
      <#include "navbar.ftl">
        <h4><font size="+1" color="#1494ff">当前已注册实例 <font size="-5">Instances currently registered with Eureka</font></font></h4>
      <table id='instances' class="table table-striped table-hover">
        <thead>
          <tr><th>应用名称</th><th>AMIs</th><th>可用区域</th><th>状态</th></tr>
        </thead>
        <tbody>
          <#if apps?has_content>
            <#list apps as app>
          ...
          <#else>
            <tr><td colspan="4">没有可用的结果</td></tr>
          </#if>

        </tbody>
      </table>

        <h4><font size="+1" color="#1494ff">一般信息 <font size="-5">General Info</font></font></h4>
      ...
      <table id='generalInfo' class="table table-striped table-hover">
        ...
        <h4><font size="+1" color="#1494ff">实例信息 <font size="-5">Instance Info</font></font></h4>
